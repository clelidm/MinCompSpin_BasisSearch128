...
/***************************   Constant variables   ***************************/
/******************************************************************************/
const uint32_t one32 = 1;  // we only need the first bit here -->> will be used to check the lowest bit of other unsigned integer (with arbitrarily larger number of bits)
