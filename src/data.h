...
struct Operator128
{
  __int128_t bin;     // binary representation of the operator
  ...
  bool operator < (const Operator128 &other) const   // for ranking Operators from the most to the less likely
